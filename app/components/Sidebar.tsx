...
export default function Sidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`
        fixed inset-y-0 left-0 z-50 w-64 bg-jarvis-darker border-r border-jarvis-border flex flex-col transform transition-transform duration-300 ease-in-out
      ...
      `}>
        ...
        <div className="p-5 border-b border-jarvis-border">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              className="md:hidden p-2 text-jarvis-muted hover:text-jarvis-text transition-colors cursor-pointer"
            >
